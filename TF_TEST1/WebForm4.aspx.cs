...
namespace TF_TEST1
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        {
            cmd.CommandText = "select * from Training_Info where Training_Id=" + Session["username"] + "";
            cmd.Connection = con;
            sda.SelectCommand = cmd;
            sda.Fill(ds);
            Label2.Text = ds.Tables[0].Rows[0]["Job_Titel"].ToString();
            Label3.Text = ds.Tables[0].Rows[0]["Training_Id"].ToString();
