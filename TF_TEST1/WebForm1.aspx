            ...
            <div class="card_title">تسجيل الدخول</div>
                ...
                <div class="card_input">
                    <div class="user_name_container">
                        <asp:TextBox ID="User_ID" runat="server" placeholder="رقم المستخدم"  dir="rtl"></asp:TextBox>
                    </div>
                    <div class="password_container">
                        <asp:TextBox ID="User_Password" runat="server" placeholder="كلمة المرور"  dir="rtl" TextMode="Password"></asp:TextBox>
                    </div>
