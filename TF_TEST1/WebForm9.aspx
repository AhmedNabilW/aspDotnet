<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm9.aspx.cs" Inherits="TF_TEST1.WebForm9" %>
            ...
            <table class="auto-style7">
                <tr>
                    ...
                    <td class="auto-style16">
                        <asp:Label ID="Label2" runat="server" CssClass="auto-style17" Text="الغياب (المشرف الاكاديمي)"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
              ...
              <table class="auto-style7">
                  <tr>
                      ...
                      <td class="auto-style28">
                          ...
                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:project databaseConnectionString %>" SelectCommand="SELECT [Name_Student] FROM [Student_Info]"></asp:SqlDataSource>
                      </td>
                      <td class="auto-style29">
                          <asp:Button ID="Button7" runat="server" BackColor="#82FF82" CssClass="auto-style30" Text="submit" Width="280px" />
                      </td>
                      <td>&nbsp;</td>
                  </tr>
              </table>
